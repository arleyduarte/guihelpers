...
public abstract class FormActivity extends AppCompatActivity implements IPickFileResultDelegate
{
    ...
    public static String SCHEMA_KEY_M_OPTIONS	= "multiple_options";
	public static String SCHEMA_KEY_META		= "meta";
	public static String SCHEMA_KEY_HINT		= "hint";
	
	public static  LayoutParams defaultLayoutParams = new LayoutParams( LayoutParams.FILL_PARENT, LayoutParams.WRAP_CONTENT);
	...
	public void generateForm( String data )
	{
		...
		defaultLayoutParams.setMargins(10, 20, 10, 30);
	...
	protected FormWidget getWidget( String name, JSONObject property ) 
	{
		try
		{
            ...
            if( type.equals( FormActivity.SCHEMA_KEY_DATE ) ){
                return new FormDatePicker( this, name  );
            }
			...
			{	
                ...
                else if( property.has( FormActivity.SCHEMA_KEY_M_OPTIONS ) )
                {
                    JSONObject options = property.getJSONObject( FormActivity.SCHEMA_KEY_M_OPTIONS );
                    return new FormMultiSelectionSpinner(  this, name, options );
                }
                else{
